...
message = tk.Label(window, text="Face Recognition Attendance Management System" ,
                   bg="White"  ,
                   fg="orange"  ,
                   width=50  ,
                   height=3,
...
lbl = tk.Label(window, text="Enter ID",
               width=20,
               height=2  ,
               fg="orange"  ,
               bg="white",
...
lbl2 = tk.Label(window, text="Enter Name",
                width=20
                ,fg="orange"  ,
                bg="white"    ,
                height=2 ,
    ...
    if(is_number(Id) and name.isalpha()):
        ...
        while(True):
            ...
            if cv2.waitKey(100) & 0xFF == ord('q'):
                break
            # break if the sample number is more than 8 Images
            elif sampleNum>20:
                break
        cam.release()
...
clearButton2 = tk.Button(window, text="Clear",
                         ...
                         bg="white",
                         width=20,
                         height=2,activebackground = "linen",
                         font=('times', 15, ' bold '))
